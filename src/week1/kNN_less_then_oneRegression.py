...
# In the plotting code above, re-run 

ax.plot(x_test, y_test,'x',label='train',color='k')  #with x_test and y_test instead. According to you, which k value is the best and why?
